...
{
    public bool CanDeclareWar(Polity e) => false;
    public float MilitaryMult(Polity e) => 1f;
}

/// <summary>国家战争策略：至尊酋长（正式国家）——可宣战（阶段5 P1 拍板）。</summary>
public sealed class StateWarPolicy : IWarPolicy
{
    public bool CanDeclareWar(Polity e) => true;
    public float MilitaryMult(Polity e) => 1f;
}
...
public static class WarPolicies
{
    ...
    public static IWarPolicy Of(Polity e) =>
