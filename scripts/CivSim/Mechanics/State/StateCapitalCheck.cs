...
public static class StateCapitalCheck
{
    ...
    public static Settlement Of(Band chief, Dictionary<int, Settlement> settleById)
    {
    ...
    public static bool Check(CivSimContext ctx, Band chief, Dictionary<int, Settlement> settleById)
    {
